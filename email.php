<?php
    ...
    echo "<h2 align=center>E-Mail Campaigns Menu</h2>";
    if (!empty($_GET['action'])){
		...
		echo "<b>Campaign added successfully. Please wait...</b>";
                echo "<script>setTimeout(\"document.location.href='index.php?tabID=userMain&subID=email'\",3000);</script>";
		return;
            }
    ...
    echo "<input type='button' class='newButton' onClick=\"document.location.href='index.php?tabID=userMain&subID=email&action=new'\" value='Add a new campaign'>";
	
	$result = $campaignClass->campaignListByType($userID,'email');
	...
	echo "<br/>
            ...
            while($row = mysql_fetch_array($result)){
                ...
                echo $row['onGoing'];
                echo "</td> 
                   <td><a href=\"./index.php?tabID=userMain&subID=email&action=del&id=". $row['campaignID'] ."\">
